...
// Pengganti fungsi cn() agar Anda tidak pusing membuat lib/utils
...
const dockVariants = cva(
  "supports-backdrop-blur:bg-white/10 supports-backdrop-blur:dark:bg-black/10 mx-auto mt-8 flex h-[58px] w-max items-center justify-center gap-2 rounded-2xl border border-black/10 dark:border-white/10 p-2 backdrop-blur-md bg-white/80 dark:bg-zinc-900/80 shadow-2xl"
)
